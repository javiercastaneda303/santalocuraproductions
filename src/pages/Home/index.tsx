  ...
  return (
    <div className="home-container">
      ...
      <p>
        ...
        herramientas tan diversas que proporciona el extenso arte teatral. ¿A quién va
        dirigido? Va dirigido a personas de cualquier edad. Centros escolares. Estudiantes de
        teatro, televisión. Agrupaciones culturales de asociaciones y a amantes de la lectura y
        escritura. Dinámica: Hay varios tipos de talleres, cada grupo trabaja técnicas
        diferentes, según tus necesidades. Es compatible con personas de cualquier edad y
        género, porque todos y todas tienen las puertas abiertas, los principiantes y
        experimentados. No se requiere experiencia previa. Es abierto e integrador. Adecuado
        para centros escolares donde se combinan las vivencias con participativas con la
